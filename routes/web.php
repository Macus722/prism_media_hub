...
// Route::get('/admin/orders', [App\Http\Controllers\AdminController::class, 'orders']); // Deprecated
...
Route::post('/admin/orders/{id}/reject', [App\Http\Controllers\OrderController::class, 'reject']);
...
// Reports (Using AdminController for now as placeholder for Sales Report)
Route::get('/admin/reports/sales', [App\Http\Controllers\AdminController::class, 'index']); // Reusing Dashboard for Sales Report for now
