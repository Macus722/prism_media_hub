...
<body class="bg-brand-black text-white antialiased min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-24">
                <div class="flex-shrink-0 flex items-center">
                    <span class="font-display text-2xl md:text-3xl font-black italic tracking-wider text-white"
                        style="text-shadow: 0 0 5px #fff, 0 0 10px #0ff, 0 0 20px #0ff;">
                        PRISM <span class="text-brand-blue">MEDIA HUB</span>
                    </span>
                </div>
            </div>
        </div>
    ...
    <main class="flex-grow py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="text-center mb-16">
                ...
                <div
                    class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-brand-blue/10 border border-brand-blue/30 mb-6 shadow-[0_0_15px_rgba(0,255,255,0.3)]">
                    <i class="fas fa-clipboard-check text-brand-blue text-3xl"></i>
                </div>
                <h1 class="text-3xl md:text-4xl font-extrabold mb-4 font-display tracking-wider text-white"
                    style="text-shadow: 0 0 10px rgba(255,255,255,0.3);">Review & Complete Order</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="glass-panel rounded-2xl p-8 shadow-[0_0_20px_rgba(0,0,0,0.5)] h-fit">
                    <h2 class="text-xl font-bold border-b border-brand-blue/20 pb-4 mb-6 text-brand-blue">Order Receipt
                    </h2>
                    ...
                    <div class="flex justify-between items-center text-lg font-bold">
                        ...
                        <span class="text-3xl font-black text-neon-pink" style="text-shadow: 0 0 10px #ff00ff;">RM
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="accordion-content bg-black/40">
                        ...
                        <div class="accordion-content bg-black/40">
                            <div class="p-6 space-y-4">
                                ...
                                <div
                                    ...
                                    <span class="text-sm font-bold">Prism Media Hub</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer
        class="text-center py-8 text-gray-600 text-sm border-t border-brand-blue/10 mt-12 bg-black/20 backdrop-blur-sm">
