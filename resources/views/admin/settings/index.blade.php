                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="mockup_brand_name"
                                ...
                                class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-brand-red focus:outline-none transition">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="mockup_brand_url"
                                ...
                                placeholder="e.g. prismmediahub.test"
                                class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-brand-red focus:outline-none transition">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="graph_stats_json" rows="8"
                            class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-brand-red focus:outline-none transition font-mono text-sm leading-relaxed"
