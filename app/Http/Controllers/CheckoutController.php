...
class CheckoutController extends Controller
{
    ...
    public function process(Request $request)
    {
        ...
        // Generate WA Links
        $waText = "Hi Prism Media Hub, I am interested in Order $orderId (Total: RM $grandTotal).";
    ...
    public function confirm(Request $request)
    {
        ...
        if (!$isDuplicate) {
            ...
            try {
                ...
                $headers .= 'From: Prism Media Hub Orders <no-reply@prismmediahub.com>' . "\r\n";
                ...
                // Customer Email
                $customerSubject = "Order Confirmation - Prism Media Hub";
                $customerMessage = "
        ...
        $waText = "Hi Prism Media Hub, I have placed Order {$data['order_id']} (Total: RM {$data['total_amount']}). Here is my payment receipt.";
        $waUrl = "https://wa.me/" . $this->whatsappNumber . "?text=" . urlencode($waText);
